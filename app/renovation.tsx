...
const chapters = [
  ...
  {id: 'bydleni', name: 'Obytná patra', title: 'Z rozestavěných prostorů domov.', text: 'Bourací práce a změny dispozic vystřídaly nové omítky, podlahy, kuchyně a koupelny. Ve třech obytných patrech je dnes devět dokončených bytů.', before: '/media/reko-bouraci-prace3.webp', after: '/media/02-byt-2-3.webp', beforeLabel: 'V průběhu prací', beforeAlt: 'Obytné prostory s arkýřem během bouracích prací a změn dispozic', afterAlt: 'Dokončený pokoj s arkýřem v bytě 02', position: '38% 50%', note: 'Archiv ukazuje změnu dispozic obytných pater; dnešní fotografie zachycuje byt 02. Nejde o totožné stanoviště.'},
