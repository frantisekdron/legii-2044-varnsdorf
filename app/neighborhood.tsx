...
export function Neighborhood({onGallery}: {onGallery: () => void}) {
  return <section id="lokalita" className="neighborhood section" aria-labelledby="neighborhood-title">
    ...
    <button className="neighborhood-panorama" onClick={onGallery}><img src="/media/17-okoli-a-mesto-10.webp" alt="Skutečný letecký pohled na Varnsdorf a okolní krajinu" loading="lazy"/><span className="panorama-caption"><span>VARNSDORF<small>Na úpatí Lužických hor</small></span><span>Fotografie okolí <Maximize2 size={17}/></span></span></button>
